...
Run generated code in a sandboxed child while the supervisor stays unsandboxed:

```python
from nono_py import CapabilitySet, AccessMode, is_supported, sandboxed_exec
import tempfile
import os
